        ...
        <form id="formData">
            ...
            <div class="form-group m-5">
                ...
                <input type="text" class="form-control " id="formGroupExampleInput" placeholder="Example input"
                    name="title_page" value="{{ $welcom->title_page }}">
                <p class="text-danger" style="display:none" id="error_title_page"></p>
            </div>
            <div class="form-group m-5">
                <label for="formGroupExampleInput2" class="text-light">Welcom To </label>
                <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Another input"
                    name="welcom_to" value="{{ $welcom->welcom_to }}">
                <p class="text-danger" style="display:none" id="error_welcom_to"></p>
            ...
            <div class="w-100">
                ...
                <button class="btn btn-primary m-5" id="update" product_id="{{ $welcom->id }}"> Update </button>
